...
public class VariableSuggestionPopUp extends DIbuggerPopUp {
    private static final long serialVersionUID = 6528738012375592708L;
    ...
    private void variableSuggestion() {
        ...
        typeChooser.setModel(
                new DefaultComboBoxModel<String>(new String[] { "int", "char", "long", "float", "double", "boolean" }));
    ...
    private void stepSizeSuggestion() {
        ...
        JComboBox<String> programChooser = new JComboBox<>();
        ...
        ArrayList<String> programs = mainInterface.getProgramIds();
        String[] programsAsArray = new String[programs.size()];
        programs.toArray(programsAsArray);

        programChooser.setModel(new DefaultComboBoxModel<String>(programsAsArray));
